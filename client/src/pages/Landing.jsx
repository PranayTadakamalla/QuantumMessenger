    ...
    <div className="landing-page min-h-screen">
      ...
      <nav className="bg-white shadow-sm px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-display font-bold text-2xl text-primary-600">Quantum Messenger</span>
          </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-display font-bold text-3xl mb-6">Why Choose Quantum Messenger?</h2>
          <p className="text-lg text-gray-700 mb-12">
            In an era of increasing cyber threats, traditional encryption is no longer enough. 
            Quantum Messenger leverages the principles of quantum mechanics to provide security that's 
      ...
      <section className="py-20 px-6 bg-quantum-gradient text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg opacity-90 mb-10">
            Join thousands of security-conscious users who trust Quantum Messenger for their sensitive communications.
          </p>
      ...
      <footer className="bg-dark text-white py-12 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start">
            <div className="mb-8 md:mb-0">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-display font-bold text-xl">Quantum Messenger</span>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-500">© 2025 QuantumMessenger. All rights reserved.</p>
